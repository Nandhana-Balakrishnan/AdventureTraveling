...
{
    $update="update tbl_packagebooking set payment_status=1 where booking_id='".$_GET["bid"]."'";
    $conn->query($update);
...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6">Adventure Traveling Payment GateWay</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group"> <label><span class="hidden-xs">
                                            ...
                                            <div class="input-group"> <input type="number" placeholder="MM" name="expname" class="form-control" > <input type="number" placeholder="YY" name="expname" class="form-control"> </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
