...
if(isset($_POST["btnreset"]))
{
	if($_POST["txtnew"]==$_POST["txtconfirm"])
	{
		...
		$sell="select * from tbl_agency where agency_email='".$_SESSION["femail"]."'";
		...
		{
			$up="update tbl_agency set agency_password='".$_POST["txtnew"]."' where agency_email='".$_SESSION["femail"]."'";
			$conn->query($up);
		}
