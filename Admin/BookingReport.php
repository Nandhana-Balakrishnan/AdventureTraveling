    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<?php
				...
				$i=0;
			 $selQry = "select * from tbl_packagebooking pb inner join tbl_package p on pb.package_id=p.package_id inner join tbl_agency a on a.agency_id=p.agency_id inner join tbl_user u on u.user_id=pb.user_id ";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["package_destination"]; ?></td>
                 <td align="center"><?php echo $data["package_name"]; ?></td>
